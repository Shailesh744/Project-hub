...
class ChatAI {
    ...
    _welcomePageTemplate() {
        return `
            <div class="welcome">
                <h1>Code Generator<span class="ver">${this.options.version}</span></h1>                    
                <p>Generate code with <a href="https://seapia.tech" target="_blank">Project Hub sponser by seapia.tech</a> &lt;3</p>
